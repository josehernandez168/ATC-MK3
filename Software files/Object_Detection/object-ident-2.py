...
while True:
    ...
    if len(objectInfo) > 0:
        object_box_array = objectInfo[0]
        if object_box_array[1] == 'cup'or object_box_array[1] == 'toilet' or object_box_array[1] == 'vase':#check for other objects that may result
            swipe = True
